...
> 이번 프로젝트를 통해 많은 것을 배우고 알 수 있었습니다. 특히 아무리 프론트라도 백 구조를 잘 이해해야 제가 원하는 데이터를 불러 올 수 있더군요^^ 역시 디자인과 기술적인 면은 별개였습니다. 짧은 시간이었지만 재혁킹과 프로젝트할 수 있어서 다행이었습니다. 그리고 첫 프로젝트를 통해 필요역량, 기술을 알 수 있었습니다. 싸피 2학기 시작 전 열심히 공부해야겠습니다.
